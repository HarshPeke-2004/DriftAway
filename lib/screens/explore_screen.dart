...
import 'package:driftaway/data/data.dart';
import 'package:driftaway/screens/details_screen.dart';
import 'package:driftaway/screens/feature_screen.dart';
import 'package:driftaway/screens/package_screen.dart';
import 'package:driftaway/widgets/app_drawer.dart';
          ...
          Builder(
            builder: (BuildContext context) {
              return Padding(
                ...
                child: IconButton(
                  icon: ClipOval(child: UserProfileImage()),
                  onPressed: () {
        ...
        child: Hero(
          ...
          child: Container(
            ...
            child: Stack(
              children: <Widget>[
                Padding(
                  padding: EdgeInsets.only(left: 12, bottom: 22, right: 12),
                  child: Align(
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (context) {
              return PackageScreen(selectedCountry: destination.country);
            },
          ),
        );
      },
    ...
    return GestureDetector(
      onTap: () {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => FeatureScreen(featureTitle: featureTitle),
          ),
        );
      },
      child: Padding(
